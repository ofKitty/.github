...
**Start from stock OF.** Use [openframeworks/openFrameworks](https://github.com/openframeworks/openFrameworks) and add only the addons you need. The toolkit stays `ofApp` with the addon model you already know and love.

[ofKitty/openFrameworks](https://github.com/ofKitty/openFrameworks) is for development convenience and should not be a requirement.
---
